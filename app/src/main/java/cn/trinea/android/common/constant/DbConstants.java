...
public class DbConstants {
    ...
    private static final String      TERMINATOR                                    = ";";//终端
    ...
    static {
        /**
         * sql to image sdcard cache table    //  创建 sdcard cache 表
         **/
        //  CRTATE TABLE image_sdcard_cache(_id integer primary key autoincrement,tag text,url text,path text,
        //               enter_time integer,last_used_time integer,priority integer,is_expired integer,is_foreved integer);
        ...
        //创建 TABLE_INDEX
        //CREATE  INDEX  image_sdcard_cache_table_index_tag  ON  image_sdcard_cache(tag);
        //CREATE  INDEX  image_sdcard_cache_table_index_url  ON  image_sdcard_cache(url);
