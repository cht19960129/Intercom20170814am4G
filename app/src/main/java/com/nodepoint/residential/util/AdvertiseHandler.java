...
//    }
    */
    ...
    public void initData(JSONArray rows,Messenger dialMessenger){
    ...
    public  void startSourcePlay(Context context, int ci){
        try {
            mediaPlayer= MediaPlayer.create(context,ci);
            mediaPlayer.reset();
            mediaPlayer.prepare();
            mediaPlayer.start();
...
//            voicePlayer.reset();
//            voicePlayer.setDataSource(context,uri);
//            voicePlayer.prepare();
//            voicePlayer.start();
        } catch (IOException e) {
            e.printStackTrace();
