...
public class ThreadManager {
    ...
    private static ExecutorService mSlingeThreadExecutor;
     ...
     * @return
     */
    public static ExecutorService getSlingeThread() {
        if (mSlingeThreadExecutor == null) {
            synchronized (ThreadManager.class) {
                if (mSlingeThreadExecutor == null) {

                    mSlingeThreadExecutor = Executors.newSingleThreadExecutor();
                }
            }
        }
        return mSlingeThreadExecutor;
    }
    ...
    public ExecutorService getSlingeThreadExecutor() {
        return mSlingeThreadExecutor;
    }
}
